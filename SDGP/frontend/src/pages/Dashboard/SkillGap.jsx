...
export default function SkillGap() {
  ...
  // ✅ Location handler (from LocationDetector)
            ...
            <React.Fragment key={s}>
              ...
              >
                ...
                <span className="hidden sm:inline">
                  {s === 'input' ? 'Your Profile' : 'Gap Analysis'}
                </span>
              </div>
              {i < 1 && (
                <div
                  className={`flex-1 max-w-16 h-0.5 transition-colors ${
                    step === 'result'
                      ? 'bg-purple-600'
                      : 'bg-slate-200'
                  }`}
          ...
          {step === 'input' && (
            ...
            >
              <UserInputForm 
                ...
                onLocationDetected={handleLocationDetected}   // ✅ PASS DOWN
              />
            </motion.div>
          )}
          ...
          {step === 'result' && analysisResult && (
            ...
            >
              <GapAnalysisResult
                ...
                userLocation={userLocation}   // ✅ PASS TO RESULTS
                onReset={handleReset}
              />
            </motion.div>
          )}
