...
const traitDescriptions = {
  logic: {
    ...
    description: "Problem solving, analytical thinking, and reasoning ability."
  },
  creativity: {
    name: "Creativity",
    description: "Innovation, imagination, and original thinking."
  },
  leadership: {
    name: "Leadership",
    description: "Decision making, influence, and guiding others."
  },
  empathy: {
    name: "Empathy",
    description: "Understanding emotions, communication, and emotional intelligence."
  },
  discipline: {
    name: "Discipline",
    description: "Consistency, responsibility, and self-control."
  },
  social: {
    name: "Social Skills",
  ...
  technical: {
    ...
    description: "Interest and ability in computing and technology."
  },
  risk: {
    name: "Risk Taking",
    description: "Willingness to explore uncertainty and new challenges."
  },
  focus: {
    name: "Focus",
    description: "Concentration, attention span, and persistence."
  },
  adaptability: {
    name: "Adaptability",
...
export default function ExplainabilityPanel({ career, traitScores }) {
  const getTraitMatch = () => {
    if (!career?.traits || !traitScores) return [];
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-600">
            Understanding your match with {career?.title || "this role"}
          </p>
        </div>
      </div>
            ...
            <div className="ml-7">
              ...
              <div className="flex items-center gap-4 text-sm">
                ...
                <span className="font-medium text-blue-600">
                  {Math.round(match.userStrength)}%
                </span>
              </div>

              {match.matchQuality === 'developing' && (
                <p className="text-xs text-slate-500 mt-2 italic">
                  This is an area you can strengthen through learning and practice.
                </p>
              )}
            </div>
          </motion.div>
      ...
      <div className="mt-6 p-4 bg-white/70 rounded-xl">
        <p className="text-sm text-slate-600">
          <strong className="text-slate-800">Note:</strong> These recommendations are based on your assessment.
          Use this as a guide, not a limit — growth is always possible.
        </p>
      </div>
    </motion.div>
  );
