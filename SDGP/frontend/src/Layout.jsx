  ...
  return (
    <footer className="bg-slate-950 text-slate-300">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
              Helping Sri Lankan ICT students discover career paths,
              analyze skill gaps, and build a future-ready roadmap.
            </p>

            <p className="mt-4 text-xs text-slate-500">
              Built for impact. Designed for clarity.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm">
              <Link to={createPageUrl('Profile')} className="hover:text-purple-400 transition-colors">
                Profile
              </Link>
              <Link to={createPageUrl('Settings')} className="hover:text-purple-400 transition-colors">
                Settings
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Bridging the gap between university education and industry
              demand through data-driven career intelligence.
            </p>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-slate-800 mt-12 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <span>© 2026 GrowthMap. All rights reserved.</span>
          <span>Final Year Project Prototype · Sri Lanka</span>
        </div>
